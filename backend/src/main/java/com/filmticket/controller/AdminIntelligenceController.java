...
public class AdminIntelligenceController {
    ...
    @GetMapping("/weekly-plan") public ResponseEntity<ApiResponse<List<Map<String,Object>>>> weeklyPlan(
            @RequestParam UUID movieId,
            @RequestParam(required=false) @DateTimeFormat(iso=DateTimeFormat.ISO.DATE) LocalDate startDate) {
        return ResponseEntity.ok(ApiResponse.success("Weekly plan generated",
                service.weeklyPlan(startDate, movieId)));
    }
