...
const initialGenres = [
  { id: 1, name: 'Hành động', slug: 'Action', movieCount: 0 },
  { id: 2, name: 'Phiêu lưu', slug: 'Adventure', movieCount: 0 },
  { id: 3, name: 'Hoạt hình', slug: 'Animation', movieCount: 0 },
  { id: 4, name: 'Tiểu sử', slug: 'Biography', movieCount: 0 },
  { id: 5, name: 'Hài', slug: 'Comedy', movieCount: 0 },
  { id: 6, name: 'Hình sự', slug: 'Crime', movieCount: 0 },
  { id: 7, name: 'Tài liệu', slug: 'Documentary', movieCount: 0 },
  { id: 8, name: 'Chính kịch', slug: 'Drama', movieCount: 0 },
  { id: 9, name: 'Gia đình', slug: 'Family', movieCount: 0 },
  { id: 10, name: 'Giả tưởng', slug: 'Fantasy', movieCount: 0 },
  { id: 11, name: 'Lịch sử', slug: 'History', movieCount: 0 },
  { id: 12, name: 'Kinh dị', slug: 'Horror', movieCount: 0 },
  { id: 13, name: 'Âm nhạc', slug: 'Music', movieCount: 0 },
  { id: 14, name: 'Nhạc kịch', slug: 'Musical', movieCount: 0 },
  { id: 15, name: 'Bí ẩn', slug: 'Mystery', movieCount: 0 },
  { id: 16, name: 'Lãng mạn', slug: 'Romance', movieCount: 0 },
  { id: 17, name: 'Khoa học viễn tưởng', slug: 'Science Fiction (Sci-Fi)', movieCount: 0 },
  { id: 18, name: 'Thể thao', slug: 'Sport', movieCount: 0 },
  { id: 19, name: 'Giật gân', slug: 'Thriller', movieCount: 0 },
  { id: 20, name: 'Chiến tranh', slug: 'War', movieCount: 0 },
  { id: 21, name: 'Viễn Tây', slug: 'Western', movieCount: 0 },
  { id: 22, name: 'Siêu anh hùng', slug: 'Superhero', movieCount: 0 },
  { id: 23, name: 'Tâm lý', slug: 'Psychological', movieCount: 0 },
  { id: 24, name: 'Võ thuật', slug: 'Martial Arts', movieCount: 0 },
  { id: 25, name: 'Thiếu nhi', slug: 'Kids', movieCount: 0 },
  { id: 26, name: 'Anime', slug: 'Anime', movieCount: 0 },
  { id: 27, name: 'Thảm họa', slug: 'Disaster', movieCount: 0 },
  { id: 28, name: 'Hậu tận thế', slug: 'Post-apocalyptic', movieCount: 0 },
  { id: 29, name: 'Siêu nhiên', slug: 'Supernatural', movieCount: 0 },
  { id: 30, name: 'Noir (Phim đen)', slug: 'Film Noir', movieCount: 0 },
];
